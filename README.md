...
---
HBnB is an AirBnB clone which is a complete web application, integrating database storage,a back-end API, and front-end interfacing.

This is a team project to build a clone of AirBnB.

Currently only the back-end console is implemented in the project.
